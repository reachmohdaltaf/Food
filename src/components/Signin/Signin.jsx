    ...
    <div>
        ...
        <div className="signin-conatiner h-[90vh] bg-white flex  justify-center">
            <div className="sign-in h-[100%]     bg-zinc-100 w-[90%] flex gap-10 flex-col items-center ">
               ...
               <div className="title text-3xl font-thin">Sign In</div>
                <form action="" className="flex flex-col p-5  w-full gap-5">
                    ...
                    <input className="p-2 w-full border border-zinc-400" type="text" name="" id="" />
                    </div>
                    <div className="Password w-full">
                    <h1 className="text-sm">Password:</h1>
                    <input className="p-2 w-full border border-zinc-400" type="password" name="" id="" />
                    </div>
                    <div className="button">
                        <button className="bg-zinc-800 w-full p-2 mt-10 flex items-center text-white justify-center hover:bg-black transition-all font-normal text-lg ">Sing In</button>
                    </div>
